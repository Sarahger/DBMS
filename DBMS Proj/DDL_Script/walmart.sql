...
PRIMARY KEY (inv_id)  ,
FOREIGN KEY (payment_mode_id) REFERENCES PaymentMode(payment_mode_id) ON DELETE SET NULL ON UPDATE CASCADE,
...
FOREIGN KEY (product_id) REFERENCES Product(product_id)  ON DELETE SET NULL ON UPDATE CASCADE,
FOREIGN KEY (inv_id) REFERENCES InvoiceDetails(inv_id)  ON DELETE SET NULL ON UPDATE CASCADE
);
